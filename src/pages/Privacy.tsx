          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
              ...
              <CardContent className="prose prose-sm dark:prose-invert max-w-none">
                <p>
                  PrometheusAiTechnology ("we," "us," or "our"), operated by Sel'vala-Élthony, is committed to 
            ...
            <Card>
              ...
              <CardContent className="prose prose-sm dark:prose-invert max-w-none">
                ...
                <p className="mt-4">
                  <strong>Data Controller:</strong> Sel'vala-Élthony, operating as PrometheusAiTechnology
                </p>
              </CardContent>
            </Card>
