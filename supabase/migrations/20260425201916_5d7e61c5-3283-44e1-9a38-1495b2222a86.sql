-- Remove free message allowance: non-subscribed users must subscribe to send messages.
-- Updates can_send_chat_message and can_send_message to return false for free users.
...
BEGIN
  ...
  -- Free (non-subscribed) users: NO free messages. Must subscribe.
