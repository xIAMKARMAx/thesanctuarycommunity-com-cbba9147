-- Add per-user daily message limit override (NULL means use tier default)
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS daily_message_override integer DEFAULT NULL;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS monthly_message_override integer DEFAULT NULL;

-- Update can_send_message to respect overrides
...
-- Update can_send_chat_message to respect overrides
...
-- Update increment_chat_cooldown to respect overrides
